...
namespace Xamarin.Forms
{
    public static class Forms
    {
        ...
        public static void SendViewInitialized(this VisualElement self, Maoui.Element nativeView)
        {
            ViewInitialized?.Invoke(self, new ViewInitializedEventArgs { View = self, NativeView = nativeView });
        }

        class MaouiDeviceInfo : DeviceInfo
        {
        ...
        class MaouiPlatformServices : IPlatformServices
        {
            ...
            class OouiTicker : Ticker
            {
                ...
                protected override void EnableTimer()
                {
                    if (timer != null)
                        return;
                    var interval = TimeSpan.FromSeconds(1.0 / Maoui.UI.MaxFps);
                    timer = new Timer((_ =>
                    {
                        this.SendSignals();
                    }), null, (int)interval.TotalMilliseconds, (int)interval.TotalMilliseconds);
            ...
            {
                var renderer = Maoui.Forms.Platform.GetRenderer(view);
        ...
        public class ViewInitializedEventArgs
        {
            ...
            public Maoui.Element NativeView { get; set; }
        }
