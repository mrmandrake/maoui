    ...
    public class ListViewRenderer : ViewRenderer<ListView, List>
    {
        ...
        private void UpdateSeparator()
        {
            ...
            foreach (var li in listItems)
            {
                ...
                {
                    var color = Element.SeparatorColor.ToMaouiColor(Color.FromStyleValue("#999"));
        ...
        void ListView_ScrollToRequested(object sender, ScrollToRequestedEventArgs e)
        {
            ...
            switch (e.Position)
            {
                case ScrollToPosition.Start:
                    Control.Send(Maoui.Message.Set(Control.Id, "scrollTop", 0));
                    break;
                case ScrollToPosition.End:
                    Control.Send(Maoui.Message.Set(Control.Id, "scrollTop", new Maoui.Message.PropertyReference { TargetId = Control.Id, Key = "scrollHeight" }));
                    break;
            }
        }
        ...
        void UpdateBackgroundColor()
        {
            ...
            var backgroundColor = Element.BackgroundColor.ToMaouiColor(Xamarin.Forms.Color.White);
