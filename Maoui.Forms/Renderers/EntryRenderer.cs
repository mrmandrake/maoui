...
{
    public class EntryRenderer : ViewRenderer<Entry, Maoui.TextInput>
    {
        bool _disposed;
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Entry> e)
        {
            ...
            if (Control == null)
            {
                var textField = new Maoui.TextInput();
        ...
        {
            Control.Style.TextAlign = Element.HorizontalTextAlignment.ToMaouiTextAlign();
        }

        void UpdateColor()
        {
            Control.Style.Color = Element.TextColor.ToMaouiColor(MaouiTheme.TextColor);
        }
