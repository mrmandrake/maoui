...
namespace Maoui.Forms.Renderers
{
    public class LinkLabelRenderer : ViewRenderer<LinkLabel, Anchor>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Maoui.Forms.LinkLabel> e)
        {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == Maoui.Forms.LinkLabel.HRefProperty.PropertyName)
                UpdateHRef();
            if (e.PropertyName == Maoui.Forms.LinkLabel.TargetProperty.PropertyName)
                UpdateTarget();
        ...
        {
            Style.BackgroundColor = color.ToMaouiColor(Colors.Clear);
        }
        ...
        void UpdateAlignment()
        {
            ...
            this.Style.TextAlign = Element.HorizontalTextAlignment.ToMaouiTextAlign();
        ...
        {
            _perfectSizeValid = false;
            var formatted = Element.GetValue(Xamarin.Forms.Label.FormattedTextProperty) as FormattedString;
            if (formatted != null)
            {
                Control.Text = (string)Element.GetValue(Xamarin.Forms.Label.TextProperty);
